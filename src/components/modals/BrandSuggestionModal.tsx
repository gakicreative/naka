    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-surface w-full max-w-sm rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="flex items-center justify-between p-6 border-b border-outline-variant/30">
          <h2 className="text-xl font-headline font-semibold text-on-surface">{t('brandSuggestion.title')}</h2>
        ...
        <div className="p-6 space-y-6">
          <p
            ...
            dangerouslySetInnerHTML={{ __html: t('brandSuggestion.description', { name: clientName }) }}
          />
