      ...
      <div className="w-full max-w-md space-y-10">
        ...
        <div className="bg-surface-container-low rounded-3xl p-8 border border-surface-container-high shadow-xl">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-black font-medium transition-all hover:bg-gray-100 active:scale-[0.98]"
          >
